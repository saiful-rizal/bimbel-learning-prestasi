...
export default function TestimonialSection() {
    return (
        <div id="testimonials" className="px-4 md:px-16 lg:px-24 xl:px-32 bg-black py-24">
            <SectionTitle 
                text1="Testimonial" 
                text2="Kesuksesan Nyata" 
                text3="Simak cerita sukses siswa yang telah mencapai target akademik mereka bersama Learning Prestasi." 
            />
